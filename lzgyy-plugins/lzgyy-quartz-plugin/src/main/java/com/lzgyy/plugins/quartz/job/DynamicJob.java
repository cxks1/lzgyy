package com.lzgyy.plugins.quartz.job;
    ...
    public void execute(JobExecutionContext executorContext) throws JobExecutionException {
        ...
        if (!StringUtils.isEmpty(jarPath)) {
            ...
            if (jar.exists()) {
                ...
                commandsList.add("java");
                if (!StringUtils.isEmpty(vmParam)) commandsList.add(vmParam);
                commandsList.add("-jar");
                commandsList.add(jarPath);
                if (!StringUtils.isEmpty(parameter)) commandsList.add(parameter);
